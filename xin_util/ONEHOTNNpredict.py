...
def Onehot_Network_classify(input_df,feature_column,label_column,process_text=False,
    ...
    history = model.fit(patial_x_train, patial_y_train, batch_size=batch_size, epochs=epochs, validation_data=(x_val, y_val))
