...
class MyLDA:
    def __init__(self,input_df,feature_column,process_text=False,random_state=1,max_features=1000,alpha=None,eta=None,n_topics=10,batch_size=128,max_iter=10,verbose=1):
        df = input_df.copy()
        if process_text:
